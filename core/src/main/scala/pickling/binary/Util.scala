...
package binary {
  ...
  object Util {
    ...
    def encodeString(arr: ArrayOutput[Byte], value: String): Unit = {
      ...
      val buf = Array.ofDim[Byte](bytes.length * SizeOfByte)
      encodeByteArrayTo(buf, 0, bytes)
      arr.put(buf)
    }

    def encodeByteArray(arr: ArrayOutput[Byte], value: Array[Byte]): Unit = {
      encodeInt(arr, value.length)
      val buf = Array.ofDim[Byte](value.length * SizeOfByte)
      encodeByteArrayTo(buf, 0, value)
      arr.put(buf)
    }
    
    def encodeShortArray(arr: ArrayOutput[Byte], value: Array[Short]): Unit = {
      encodeInt(arr, value.length)
      val buf = Array.ofDim[Byte](value.length * SizeOfShort)
      encodeShortArrayTo(buf, 0, value)
      arr.put(buf)
    }
    
    def encodeIntArray(arr: ArrayOutput[Byte], value: Array[Int]): Unit = {
      encodeInt(arr, value.length)
      val buf = Array.ofDim[Byte](value.length * SizeOfInt)
      encodeIntArrayTo(buf, 0, value)
      arr.put(buf)
    }
    
    def encodeLongArray(arr: ArrayOutput[Byte], value: Array[Long]): Unit = {
      encodeInt(arr, value.length)
      val buf = Array.ofDim[Byte](value.length * SizeOfLong)
      encodeLongArrayTo(buf, 0, value)
      arr.put(buf)
    }
    
    def encodeFloatArray(arr: ArrayOutput[Byte], value: Array[Float]): Unit = {
      encodeInt(arr, value.length)
      val buf = Array.ofDim[Byte](value.length * SizeOfFloat)
      encodeFloatArrayTo(buf, 0, value)
      arr.put(buf)
    }
    
    def encodeDoubleArray(arr: ArrayOutput[Byte], value: Array[Double]): Unit = {
      encodeInt(arr, value.length)
      val buf = Array.ofDim[Byte](value.length * SizeOfDouble)
      encodeDoubleArrayTo(buf, 0, value)
      arr.put(buf)
    }
    
    def encodeBooleanArray(arr: ArrayOutput[Byte], value: Array[Boolean]): Unit = {
      encodeInt(arr, value.length)
      val buf = Array.ofDim[Byte](value.length * SizeOfBoolean)
      encodeBooleanArrayTo(buf, 0, value)
      arr.put(buf)
    }
    
    def encodeCharArray(arr: ArrayOutput[Byte], value: Array[Char]): Unit = {
      encodeInt(arr, value.length)
      val buf = Array.ofDim[Byte](value.length * SizeOfChar)
      encodeCharArrayTo(buf, 0, value)
      arr.put(buf)
    }
  ...
  object UnsafeMemory {
    ...
    val shortArrayOffset: Long = unsafe.arrayBaseOffset(classOf[Array[Short]])
    val intArrayOffset: Long  = unsafe.arrayBaseOffset(classOf[Array[Int]])
    val longArrayOffset: Long = unsafe.arrayBaseOffset(classOf[Array[Long]])
    val booleanArrayOffset: Long = unsafe.arrayBaseOffset(classOf[Array[Boolean]])
    val doubleArrayOffset: Long = unsafe.arrayBaseOffset(classOf[Array[Double]])
    val charArrayOffset: Long = unsafe.arrayBaseOffset(classOf[Array[Char]])
    val floatArrayOffset: Long = unsafe.arrayBaseOffset(classOf[Array[Float]])
    
    def putInt(arr: Array[Byte], i: Int, value: Int): Unit = {
      val endian = value << 24 | (value >> 8 << 16) | (value >> 16 << 8) | (value >> 24)  
      unsafe.putInt(arr, byteArrayOffset + i, endian)
    }
